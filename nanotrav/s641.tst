...
Number of cache look-ups: 101647
Number of cache hits: 38944
Number of cache insertions: 64667
Number of cache collisions: 10804
Number of cache deletions: 39992
Cache used slots = 21.17% (expected 21.32%)
Soft limit for cache size: 225280
Number of buckets in unique table: 56320
Used buckets in unique table: 6.80% (expected 6.75%)
...
Maximum resident size            =  7064K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1688
Swaps = 0
Input blocks = 24
Output blocks = 88

...
{ rank = same; "CONST NODES";
{ node [shape = box]; "0x489";
}
}
"  s0  " -> "0x506" [style = solid];
"  s1  " -> "0x508" [style = solid];
"  s2  " -> "0x50a" [style = solid];
"  c3  " -> "0x50b" [style = solid];
"0x50a" -> "0x509";
"0x50a" -> "0x509" [style = dotted];
"0x50b" -> "0x490";
"0x50b" -> "0x509" [style = dashed];
"0x490" -> "0x489";
"0x490" -> "0x489" [style = dotted];
"0x508" -> "0x507";
"0x508" -> "0x507" [style = dotted];
"0x509" -> "0x4c2";
"0x509" -> "0x507" [style = dashed];
"0x4c2" -> "0x489";
"0x4c2" -> "0x489" [style = dotted];
"0x506" -> "0x505";
"0x506" -> "0x505" [style = dotted];
"0x507" -> "0x4e1";
"0x507" -> "0x505" [style = dashed];
"0x4e1" -> "0x489";
"0x4e1" -> "0x489" [style = dotted];
"0x505" -> "0x489";
"0x505" -> "0x489" [style = dotted];
"0x489" [label = "1"];
}
